...
/***/ "./samples/chapters/chapter-9/load-fbx.js"
/*!************************************************!*\
  !*** ./samples/chapters/chapter-9/load-fbx.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const loadModel = () => {
  ...
  return loader.loadAsync('/assets/models/salsa/salsa.fbx').then((container) => {
    ...
    ;(0,_util_modelUtil__WEBPACK_IMPORTED_MODULE_2__.applyShadowsAndDepthWrite)(container)
    return container
  })
}
...
;(0,_util_standard_scene__WEBPACK_IMPORTED_MODULE_0__.bootstrapMeshScene)({
  ...
  addControls: (camera, renderer, scene, gui, mesh) => {
    ...
    const clip = three__WEBPACK_IMPORTED_MODULE_4__.AnimationClip.findByName(clips, 'mixamo.com')
