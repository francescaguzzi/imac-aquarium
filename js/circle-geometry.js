...
/***/ "./samples/chapters/chapter-5/circle-geometry.js"
/*!*******************************************************!*\
  !*** ./samples/chapters/chapter-5/circle-geometry.js ***!
  \*******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const updateGeometry = ({ radius, segments, thetaStart, thetaLength }) => {
  return new three__WEBPACK_IMPORTED_MODULE_0__.CircleGeometry(radius, segments, thetaStart, thetaLength)
}
...
const props = {
  ...
  provideGui: (gui, mesh) => {
    ...
    folder.add(circleProps, 'radius', 0, 10, 0.01).onChange(() => (0,_util__WEBPACK_IMPORTED_MODULE_2__.updateMesh)(mesh, updateGeometry(circleProps)))
    folder.add(circleProps, 'segments', 0, 50, 1).onChange(() => (0,_util__WEBPACK_IMPORTED_MODULE_2__.updateMesh)(mesh, updateGeometry(circleProps)))
    folder.add(circleProps, 'thetaStart', 0, 10, 0.01).onChange(() => (0,_util__WEBPACK_IMPORTED_MODULE_2__.updateMesh)(mesh, updateGeometry(circleProps)))
    folder.add(circleProps, 'thetaLength', 0, 10, 0.01).onChange(() => (0,_util__WEBPACK_IMPORTED_MODULE_2__.updateMesh)(mesh, updateGeometry(circleProps)))
  }
}

;(0,_util_standard_scene__WEBPACK_IMPORTED_MODULE_1__.bootstrapGeometryScene)(props).then()
